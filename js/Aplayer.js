                                    ...
                                    if (!this.parsed[e])
                                        if (this.async) {
                                            ...
                                            n.onreadystatechange = function () {
                                                e === t.player.list.index && 4 === n.readyState && ((n.status >= 200 && n.status < 300 || 304 === n.status) && n.responseText !== "" ? t.parsed[e] = t.parse(n.responseText) : (t.player.notice("LRC file request fails: status " + n.status), t.parsed[e] = [["00:00", "Not available"]]), t.container.innerHTML = (0, o.default)({
                                                        lyrics: t.parsed[e]
